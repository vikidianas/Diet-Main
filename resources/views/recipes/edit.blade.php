<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-normal-form-section :submit="route('recipes.update', $recipe)" method="PUT">
                <x-slot:title>
                    Ubah Resep
                </x-slot>
                ...
                <x-slot:form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-input id="name" type="text" class="mt-1 block w-full" name="name" :value="old('name', $recipe->name)" />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-textarea id="description" class="mt-1 block w-full" name="description" :value="old('description', $recipe->description)" />
                        ...
                        <x-select id="food_type_id" class="mt-1 block w-full" name="food_type_id">
                            <x-slot:options>
                                @foreach ($types as $type)
                                    <option value="{{ $type->id }}" @selected(old('food_type_id', $recipe->food_type_id) === $type->id)>{{ $type->name }}</option>
                                @endforeach
                            </x-slot>
                        </x-select>
