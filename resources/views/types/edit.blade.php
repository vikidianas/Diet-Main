<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-normal-form-section :submit="route('types.update', $type)" method="PUT">
                <x-slot:title>
                    Ubah Jenis Makanan
                </x-slot>

                <x-slot:description>
                    Memperbarui data jenis makanan
                </x-slot>
                ...
                <x-slot:form>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-jet-input id="name" type="text" class="mt-1 block w-full" name="name" :value="old('name', $type->name)" />
                    ...
                    ">
                        ...
                        <template x-for="(food, i) in foods" :key="i">
                            <div class="flex items-center justify-between gap-4 mb-4">
                                <x-jet-input type="text" class="mt-1 block w-full" name="food[]" x-model="food" />
